...
public class WindowSinglePlayer extends JFrame implements MouseListener, ActionListener {
	...
	public void createkol7aga() {
		...
		panelHolder[1][2].add(AIName);
		AIName.setFont(new Font(p1.getFont().getName(), Font.PLAIN,
				64));
	...
	public void initPlayWindow(ArrayList<JLabel> picked1,ArrayList<JLabel> picked2){
		...
		if (picked2.get(0) == cube3) {
			player2 = new PlayerAI(1);
		}
		if (picked2.get(0) == pyramid3) {
			player2 = new PlayerAI(2);
		}
	...
	public JLabel getAIName() {
		return AIName;
	}

	public void setAIName(JLabel aIName) {
		AIName = aIName;
	}
